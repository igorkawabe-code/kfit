...
const SIZES = {
  xs:  { div: 'w-7 h-7',   text: 'text-xs',  ring: 3 },
  sm:  { div: 'w-8 h-8',   text: 'text-xs',  ring: 3 },
  md:  { div: 'w-10 h-10', text: 'text-sm',  ring: 3 },
  lg:  { div: 'w-12 h-12', text: 'text-base',ring: 4 },
  xl:  { div: 'w-14 h-14', text: 'text-xl',  ring: 5 },
  '2xl': { div: 'w-16 h-16', text: 'text-2xl', ring: 5 },
}
