                  ...
                  return (
                    <div key={workout.id} className="flex items-start gap-3">
                      ...
                      <div className="flex items-start gap-2 flex-1">
                        <div className="w-7 h-7 rounded-full flex items-center justify-center font-display text-sm text-inherit flex-shrink-0 mt-0.5"
                          style={{ backgroundColor: p?.color || '#B4FF00' }}>
                          {getFirstName(p?.name)?.[0]}
                        </div>
                        <div>
                          <div className="font-body font-semibold text-white text-sm">{getFirstName(p?.name)}</div>
              ...
              return (
                <div key={workout.id} className="flex items-center gap-3 py-3 border-b border-zinc-800 last:border-0">
                  {workout.photo_url ? (
                    ...
                    <div className="w-10 h-10 rounded-full flex items-center justify-center font-display text-sm text-inherit flex-shrink-0"
                      style={{ backgroundColor: p?.color || '#B4FF00' }}>
                      {getFirstName(p?.name)?.[0]}
                    </div>
                  )}
