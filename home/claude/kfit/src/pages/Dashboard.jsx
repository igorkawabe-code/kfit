...
export default function Dashboard() {
  ...
  return (
    <Layout>
      <div className="px-5 py-6 safe-top space-y-5 animate-fade-in">
        {/* Header */}
        <div className="flex items-start justify-between">
          ...
          <div className="w-11 h-11 rounded-full flex items-center justify-center font-display text-lg text-inherit"
            style={{ backgroundColor: profile?.color || '#B4FF00' }}>
          ...
          <div className="space-y-2.5">
            {weekRanking.map((p, i) => (
              <div key={p.id} className={`flex items-center gap-3 ${p.id === profile?.id ? 'opacity-100' : 'opacity-80'}`}>
                ...
                <div className="w-8 h-8 rounded-full flex items-center justify-center font-display text-sm text-inherit flex-shrink-0"
